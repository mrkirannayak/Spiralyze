    ...
    $("#nav li.parent .menuIcon")
      ...
      .bind("click", function (e) {
        ...
        if ($(this).hasClass("active")) {
          ...
          $("html, body").animate({ scrollTop: navtop.top }, "200");
        }
      });
  } else {
...
!(function (e, t) {
  ...
  (o.prototype = {
        ...
        e("body")
          ...
          .on("keyup", function (o) {
            t.options.escKey && o.keyCode == keyEsc && t.closeLitebox(),
              t.options.navKey &&
                o.keyCode == keyLeft &&
                e(".litebox-prev").trigger("click"),
              t.options.navKey &&
                o.keyCode == keyRight &&
                e(".litebox-next").trigger("click");
          }),
    ...
    openLitebox: function () {
      ...
      if (
        (t.populateLitebox(o),
        t.options.overlayClose &&
          $litebox.on("click", function (o) {
            (o.target === this ||
              e(o.target).hasClass("litebox-container") ||
              e(o.target).hasClass("litebox-error")) &&
              t.closeLitebox();
          }),
    ...
    populateLitebox: function (t) {
      ...
      if (
        ("undefined" == typeof l || "" == l
          ? (e(".litebox-text").removeClass("active"),
            e(".litebox-text").html())
          : (e(".litebox-text").html(l), e(".litebox-text").addClass("active")),
        null !== i.match(/\.(jpeg|jpg|gif|png|bmp)/i))
      ) {
        var a = e("<img>", { src: i, class: "litebox-content" });
        o.transitionContent("image", n, a),
          e("img.litebox-content").imagesLoaded(function () {
            $loader.remove();
          }),
          a.error(function () {
        ...
        if (
          ("youtube" == videoURL[1] &&
            (r = "http://www.youtube.com/v/" + videoURL[5]),
          "youtu" == videoURL[1] &&
            (r = "http://www.youtube.com/v/" + videoURL[3]),
          "vimeo" == videoURL[1] &&
            (r = "http://player.vimeo.com/video/" + videoURL[3]),
          "dailymotion" == videoURL[1] &&
            (r = "https://www.dailymotion.com/embed/video/" + videoURL[7]),
        ...
        e(i).length
          ? (($html = e("<div>", {
            ...
            $html.append(e(i).clone()),
            o.transitionContent("inline", n, $html))
          : o.liteboxError(),
          $loader.remove();
      else {
        var s = e("<iframe>", {
        ...
        o.transitionContent("iframe", n, s),
          s.load(function () {
            $loader.remove();
          });
      }
    ...
    transitionContent: function (o, i, n) {
      ...
      "inline" != o && $container.removeClass("litebox-scroll"),
        i.remove(),
        $container.append(n),
        "inline" == o && $container.addClass("litebox-scroll"),
        l.centerContent(),
    ...
    centerContent: function () {
      $litebox.css({ height: i() }),
        ...
        "undefined" != typeof $html &&
          e(".litebox-inline-html").outerHeight() < $container.height() &&
          e(".litebox-inline-html").css({
            "margin-top":
              "-" + e(".litebox-inline-html").outerHeight() / 2 + "px",
            top: "50%",
          });
    },
    closeLitebox: function () {
      this.options.callbackBeforeClose.call(this),
        ...
        e(".litebox-prev").off("click"),
        e(".litebox-next").off("click"),
